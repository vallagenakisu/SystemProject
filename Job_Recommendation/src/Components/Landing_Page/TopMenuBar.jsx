  ...
  return (
    <>
      <nav class="relative px-4 py-4 flex justify-between items-center bg-white">
        ...
        <div class="lg:hidden">
          <button class="navbar-burger flex items-center text-primaryfontcolor p-3">
            <svg
        ...
        <ul class="hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 lg:flex lg:mx-auto  lg:items-center lg:w-auto lg:space-x-6">
          <li>
            <a class="text-sm text-black  hover:text-primaryfontcolor hover:font-bold hover:scale-150 ease-in-out duration-150" href="#">
              Home
            </a>
          </li>
          ...
          <li>
          <a class="text-sm text-black  hover:text-primaryfontcolor hover:font-bold hover:scale-110 ease-in-out duration-150" href="#">
              Features
            </a>
          </li>
          <li class="text-gray-300">
